          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                <li>Resolve 50+ technical support cases monthly across all severity levels, with 80% specialization in AWS CloudFormation, AWS CDK, Elastic Beanstalk, Control Tower, CodePipeline, and Amazon Q Developer</li>
                <li>Architect and implement AWS best practices for enterprise customers, improving security posture, fault tolerance, system performance, and reducing operational costs</li>
                <li>Develop Model Context Protocol (MCP) Servers using Python to automate CloudFormation and CodePipeline troubleshooting, reducing MTTR</li>
                <li>Collaborate with TAMs, Professional Services, and Solution Architects on high-priority escalations; participate in on-call rotation for SEV-1 and SEV-2 incidents</li>
